...
let PostResolver = class PostResolver {
    ...
    createPost(title, body, description, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
            const post = em.create(Post_1.Post, { title, body, description });
            yield em.persistAndFlush(post);
            return post;
        });
    }
    updatePost(id, title, body, description, { em }) {
        return __awaiter(this, void 0, void 0, function* () {
...
__decorate([
    ...
    __param(1, type_graphql_1.Arg('body', () => String, { nullable: true })),
...
__decorate([
    ...
    __param(2, type_graphql_1.Arg('body', () => String, { nullable: true })),
